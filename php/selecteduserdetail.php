...
<body style="background-color : #E59866 ;">
  ...
  if (isset($_POST['submit'])) {
    ...
    if (($amount) <= 0) {
      ...
      echo ' alert("Error! The amount must be positive")';
      echo '</script>';
  ...
  <nav class="navbar navbar-expand-md navbar-light">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="createuser.php" style="color : #C0392B;"><b>Create</b></a></li>
    ...
    <form method="post" name="tcredit" class="tabletext"><br>
      ...
      <select name="to" class="form-control" required>
        ...
        while ($rows = mysqli_fetch_assoc($result)) {
          echo '<option class="table" value="' . $rows['id'] . '">';
          echo $rows['name'] . '(Balance: ' . $rows['balance'] . ')';
          echo '</option>';
        }
        ?>
      </select><br><br>
